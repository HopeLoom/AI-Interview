...
export function ReadyToJoinScreen({ isOpen, onJoin, onCancel }: ReadyToJoinScreenProps) {
  const { user } = useUser();
  const { stream, isReady, isStarting, error, startStream, stopStream } = useCamera();
    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      ...
      >
        ...
        <DialogDescription className="sr-only">
          Camera and microphone check before joining interview
        </DialogDescription>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                ...
                <span>
                  ...
                  <span className="font-semibold">Only unmute your microphone when speaking</span>,
                  and mute it when listening to prevent AI from detecting background noise.
                </span>
              </li>
              <li className="flex items-center">
                <Video className="h-5 w-5 text-blue-600 mr-2 flex-shrink-0" />
                <span>
                  Your interview will be <span className="font-semibold">recorded</span> for
                  evaluation purposes.
                </span>
              </li>
              <li className="flex items-center">
