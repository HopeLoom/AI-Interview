...
from core.database.base import DatabaseInterface, UserProfile, SessionData, DatabaseType
...
class MockDatabaseInterface(DatabaseInterface):
    ...
    async def store_simulation_config(self, config_id: str, config_data: dict, user_id: str = None) -> bool:
    ...
    async def list_simulation_configs(self, user_id: str = None):
        return [{"config_id": k, "config_name": v.get("job_details", {}).get("job_title", "Untitled")} 
    ...
    async def add_to_batch(self, user_id: str, session_id: str, operation_type: str, data, collection_path: str):
        pass
    
    async def commit_batch(self) -> bool:
        return True
    
    async def add_json_data_output_to_database(self, user_id: str, session_id: str, name: str, json_data: dict):
        pass
...
class TestDatabaseInterface:
    ...
    async def test_session_operations(self, mock_db, sample_user_profile):
        ...
        recent_session_id = await mock_db.get_most_recent_session_id_by_user_id(sample_user_profile.user_id)
