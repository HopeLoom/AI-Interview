...
async def example_sqlite_usage():
    ...
    try:
        ...
        if success:
            ...
            await db.add_json_data_output_to_database(test_user.user_id, session_id, "test_data", test_data)
            print("✅ Added JSON data")
            
            # Retrieve the data
            retrieved_data = await db.get_json_data_output_from_database("test_data", test_user.user_id, session_id)
            if retrieved_data:
...
async def example_comprehensive_workflow():
    ...
    try:
        ...
        messages = [
            ...
            MockMessage("Candidate", "I've been using Python for web development and data analysis.")
        ]
        ...
        await db.add_json_data_output_to_database(user.user_id, session_id, "evaluation", evaluation_data)
