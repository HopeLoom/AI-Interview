...
from memory.base import MemoryConfiguration, Passage, TableType
...
def get_db_model(config: MemoryConfiguration, table_name: str, table_type: TableType):
...
class SqliteStorageConnector(StorageConnector):
    ...
    def get_filters(self):
        ...
        all_filters = [
            getattr(self.db_model, key) == value for key, value in filter_conditions.items()
        ]
