from core.memory.base import MemoryConfiguration, TableType, Passage
...
class StorageConnector:
    ...
    @staticmethod
    def get_storage_connector(table_type:str,
                              config:MemoryConfiguration,
                              user_id,
                              agent_id=None):
    ...
    def get_long_memory_storage_connector(config:MemoryConfiguration, user_id, agent_id=None):
        return StorageConnector.get_storage_connector(TableType.LONG_MEMORY, config, user_id, agent_id)
    
    @staticmethod
    def get_short_memory_storage_connector(config:MemoryConfiguration, user_id, agent_id=None):
        return StorageConnector.get_storage_connector(TableType.SHORT_MEMORY, config, user_id, agent_id)
