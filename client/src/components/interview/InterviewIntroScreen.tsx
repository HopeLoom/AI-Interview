    ...
    <Dialog open={isOpen} onOpenChange={() => {}}>
      ...
      >
        <div className="p-6">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 text-blue-500">
              ...
              <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M12 2L8 6L4 2L2 4L6 8L2 12L4 14L8 10L12 14L16 10L20 14L22 12L18 8L22 4L20 2L16 6L12 2Z"
                  fill="currentColor"
                />
          ...
          {/* Description */}
          <p className="text-center mb-8 text-neutral-700">{introduction}</p>
            ...
            {panelists.map((panelist, index) => (
              <div key={index} className="border border-neutral-200 rounded-lg p-4 bg-neutral-50">
                ...
                <p className="text-neutral-600 text-sm italic mb-2">
                  {panelist.interview_round_part_of}
                </p>
          ...
          <div className="flex justify-center">
            <Button onClick={onClose} className="bg-blue-600 hover:bg-blue-700 py-2 px-6 text-base">
              OK
            </Button>
          </div>
        </div>
