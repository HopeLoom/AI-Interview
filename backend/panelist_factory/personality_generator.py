...
from panelist_agent.base import INTENSITY_LEVELS
import json
from interview_details_agent.base import CharacterData
from panelist_agent.base import Background
...
class PersonalityGenerator():
    ...
    def build_user_prompt(self, background:Background, character_data):
        ...
        user_prompt = ( "The following is the background information about the character for which personality information has to be generated:\n"
...
async def generate_personality_info(llm_provider, background:Background, character_data:CharacterData):
