...
from core.config.config_manager import (
    ConfigManager, ApplicationConfig, DatabaseConfig, StorageConfig,
    LLMProviderConfig, EmailConfig, SpeechConfig, SecurityConfig,
    Environment
)
...
class TestGlobalFunctions:
    ...
    def test_global_config_functions(self, test_config_file):
        """Test global configuration functions"""
        from core.config.config_manager import config_manager, get_config, get_database_config, get_storage_config
